...
AKillZone::AKillZone()
{
	...
	boxComp = CreateDefaultSubobject<UBoxComponent>(TEXT("Box Collsion"));
	SetRootComponent(boxComp);
	boxComp->SetBoxExtent(FVector(50.0f, 2000.0f, 50.0f));
	boxComp->SetCollisionProfileName(TEXT("NewKillZone"));	
}
